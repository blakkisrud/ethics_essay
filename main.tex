...
This is a balance that is not easy to walk.
...
Solid evidence and numerous anecdotal evidence show that doctors tend to cheat when they are conduction experiments, showcased in the marvelous article "Subverting randomization in Controlled trials" [cite]
